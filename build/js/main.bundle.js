...
const slider = new _modules_slider__WEBPACK_IMPORTED_MODULE_0__.default('.quote', {
  loop: true,
  autoplay: true,
  swipe: true
});
...
/* harmony export */   "default": () => (/* binding */ ItcSimpleSlider)
/* harmony export */ });
...
class ItcSimpleSlider {
  ...
  _addEventListener() {
    ...
    if (this._config.swipe) {
      const options = ItcSimpleSlider.checkSupportPassiveEvents() ? {
        passive: false
      } : false;
...
_defineProperty(ItcSimpleSlider, "PREFIX", 'quote');

_defineProperty(ItcSimpleSlider, "CLASS_NAME_ITEM", `${ItcSimpleSlider.PREFIX}__item`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_ITEM_ACTIVE", `${ItcSimpleSlider.PREFIX}__item_active`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_ITEMS", `${ItcSimpleSlider.PREFIX}__items`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_INDICATOR", `${ItcSimpleSlider.PREFIX}__indicator`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_INDICATOR_ACTIVE", `${ItcSimpleSlider.PREFIX}__indicator_active`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_INDICATORS", `${ItcSimpleSlider.PREFIX}__indicators`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_CONTROL", `${ItcSimpleSlider.PREFIX}__control`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_CONTROL_PREV", `${ItcSimpleSlider.PREFIX}__control_prev`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_CONTROL_NEXT", `${ItcSimpleSlider.PREFIX}__control_next`);

_defineProperty(ItcSimpleSlider, "CLASS_NAME_CONTROL_SHOW", `${ItcSimpleSlider.PREFIX}__control_show`);

_defineProperty(ItcSimpleSlider, "SELECTOR_ITEMS", `.${ItcSimpleSlider.CLASS_NAME_ITEMS}`);

_defineProperty(ItcSimpleSlider, "SELECTOR_ITEM", `.${ItcSimpleSlider.CLASS_NAME_ITEM}`);

_defineProperty(ItcSimpleSlider, "SELECTOR_ITEM_ACTIVE", `.${ItcSimpleSlider.CLASS_NAME_ITEM_ACTIVE}`);

_defineProperty(ItcSimpleSlider, "SELECTOR_INDICATOR_ACTIVE", `.${ItcSimpleSlider.CLASS_NAME_INDICATOR_ACTIVE}`);

_defineProperty(ItcSimpleSlider, "SELECTOR_INDICATORS", `.${ItcSimpleSlider.CLASS_NAME_INDICATORS}`);

_defineProperty(ItcSimpleSlider, "SELECTOR_WRAPPER", `.${ItcSimpleSlider.PREFIX}__wrapper`);

_defineProperty(ItcSimpleSlider, "SELECTOR_CONTROL", `.${ItcSimpleSlider.CLASS_NAME_CONTROL}`);

_defineProperty(ItcSimpleSlider, "SELECTOR_CONTROL_NEXT", `.${ItcSimpleSlider.CLASS_NAME_CONTROL_NEXT}`);

_defineProperty(ItcSimpleSlider, "SELECTOR_CONTROL_PREV", `.${ItcSimpleSlider.CLASS_NAME_CONTROL_PREV}`);
